...
Partial Class studpass
    ...
    Private Sub InitializeComponent()
        ...
        Label3.Name = "Label3"
        Label3.Size = New Size(217, 19)
        Label3.TabIndex = 9
        Label3.Text = "THANKS FOR SIGNING UP"
        ' 
        ' Label4
        ' 
        ...
        Label4.TabIndex = 10
        Label4.Text = "LET'S SET UP YOUR STUDENT ACCOUNT!"
        ' 
        ' Label5
        ' 
        ...
        btncreate.Location = New Point(113, 275)
        btncreate.Margin = New Padding(3, 2, 3, 2)
        btncreate.Name = "btncreate"
        btncreate.Size = New Size(129, 44)
