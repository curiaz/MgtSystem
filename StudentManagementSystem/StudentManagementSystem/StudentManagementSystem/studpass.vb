...
Public Class studpass
    ...
    Private Sub btncreate_Click(sender As Object, e As EventArgs) Handles btncreate.Click
        ...
        Else
            ...
            Using cm As New MySqlCommand("INSERT INTO accounts (Students, `Password`) VALUES (@students, @Password)", cn)
                With cm.Parameters
            ...
            MessageBox.Show("Student Account successfully saved, you can now Log In", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information)
